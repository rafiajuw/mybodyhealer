...
// Hero Images (slider)
const heroImages = ["/b1.avif", "/b3.avif", "/b4.avif", "/b5.avif"];
      ...
      <section className="py-20 px-6 md:px-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            and development, keeping Customers&apos; needs at the centre of plans
            and decisions.
          </p>
          <p className="text-gray-600 leading-relaxed mt-4">
            Handling of potent molecules, competitive pricing, wide range of
            batch sizes, and low MOQ&apos;s. Body Healer&apos;s facility in Malta
            is EU-GMP compliant and licensed for the manufacturing, packaging,
            and testing of highly potent oral solids (tablets and hard capsules)
            including Investigational Medicinal Products (IMPs).
          </p>
          <p className="text-gray-600 leading-relaxed mt-4">
            In addition to its EU-GMP license, Pharmaccare Premium&apos;s
            facility is approved by the Turkish Ministry of Health, Brazilian
            Authorities (ANVISA), and the Saudi Authorities (SFDA).
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-20 bg-gray-50 grid md:grid-cols-2 gap-12">
        <div>
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <li>
              Highly flexible secondary packaging (serialization, 2D, etc.)
            </li>
            <li>Analytical method: transfer, development, validation</li>
            <li>
        ...
        <div>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            As a commercially-minded and scientifically-led partner for
            medicines development with a proven track record in formulation and
            analytical development, Pharmaccare Premium offers a one-stop shop
            solution.
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>Project management throughout the lifecycle of the project</li>
            ...
            <li>In-house stability testing for all climatic zones</li>
            <li>
              Regulatory support, dossier compilation &amp; handling variations
            </li>
          </ul>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              review:
                "Great support and timely delivery. Highly recommended!",
            },
            {
              name: "Hassan Raza",
              role: "Interface Designer",
              review:
                "Very satisfied with the product quality and professionalism.",
            },
          ].map((item, index) => (
            <div
              key={index}
              className="bg-white shadow-lg rounded-2xl p-6 text-left border"
            >
